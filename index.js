...
*/
console.log(createMenuItem("Corndogs", 2, "Lunch"));
console.log(createMenuItem("Meatloaf", 5, "Dinner"));
console.log(createMenuItem("Soda", 1.5, "Drink"));
...
*/
reviews.push({name: "Jordan", rating: 5, feedback: "My sample rating"});
